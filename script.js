...
function submit() {
    ...
    if (true) { //밀리 셀렉터
        ...
        if (randp == 526 || randp == 527) {
            ...
            hints = "ㅋㄹㅁㄴㄹㄷㄴ~ㅈㅊㄱㅇㅂㄴㅇㅍ~";
            answer[0] = "Criminally Dinner ~정찬과 이블나이프~";
            answer[1] = "Criminally Dinner";
            answer[2] = "criminallydinner";
            answer[3] = "크리미널리 디너";
            answer[4] = "크리미날리 디너";
            answer[5] = "크리미널리디너";
            answer[6] = "크리미널리 디너 ~정찬과 이블나이프~";
            answer[7] = "criminally dinner ~정찬과 이블나이프~";
            ...
            hints = "ㅋㅇㅂㅅㅍㅇㄷ";
            answer[0] = "KING of SPADE";
            answer[1] = "king of spade";
            answer[2] = "킹 오브 스페이드";
            answer[3] = "킹오브 스페이드";
            answer[4] = "킹 오브스페이드";
            answer[5] = "킹오브스페이드";
            ...
            answer[0] = "사운드 오브 비기닝";
            answer[1] = "시작의 소리";
            answer[2] = "sound of begining";
            answer[3] = "사운드오브비기닝";
            answer[4] = "사오비";
            answer[5] = "Sound of Begining";
        }if (randp == 584 || randp == 585) {
            hints = "ㅅㅍㅅㄴㅂㅅㅌ!";
            answer[0] = "Supersonic Booster!";
            answer[1] = "Supersonic Booster";
            answer[2] = "supersonic booster!";
            answer[3] = "supersonic booster";
            answer[4] = "수퍼소닉 부스터!";
            answer[5] = "수퍼소닉 부스터";
            answer[6] = "슈퍼소닉 부스터!";
            answer[7] = "슈퍼소닉 부스터";
            ...
            answer[2] = "오렌지 애피소드";
            answer[3] = "오렌지애피소드";
            answer[4] = "orange episode";
            answer[5] = "Orange Episode";
        }if (randp == 588 || randp == 589) {
            hints = "ㄹㅇㅋㅌㅇㅋㄹㅅㅌㅅ";
            answer[0] = "Like twinkling STARS";
            answer[1] = "like twinkling stars";
            answer[2] = "라이크 트윙클링 스타스";
            answer[3] = "라이크 트윙클링 스타";
            answer[4] = "라이크 트윈클링 스타스";
            answer[5] = "라트스";
    ...
    if (true) { //데레 셀렉터
        ...
        if (randp == 1741 || randp == 1742) {
            ...
            hints = "ㄴㅂㄹㅇㅌㅅㅌㅅ";
            answer[0] = "New bright stars";
            answer[1] = "new bright stars";
            answer[2] = "new bright star";
            answer[3] = "뉴 브라이트 스타스";
            answer[4] = "뉴 브라이트 스타";
            answer[5] = "뉴브라이트스타스";
            answer[6] = "뉴브라이트스타";
            ...
            hints = "ㅅㅌㄹㄴㅇㅌ";
            answer[0] = "Starry Night";
            answer[1] = "starry night";
            answer[2] = "스태리 나이트";
            answer[3] = "스태리나이트";
            answer[4] = "스테리 나이트";
            answer[5] = "스테리나이트";
            ...
            hints = "ㅅㅇㅇㄷㅅㅋㅇ☆";
            answer[0] = "Shine In The Sky☆";
            answer[1] = "shine in the sky☆";
            answer[2] = "shine in the sky";
            answer[3] = "샤인 인 더 스카이";
            answer[4] = "샤인인더스카이";
            answer[5] = "샤인 인 더 스카이☆";
        }if (randp == 1777 || randp == 1778) {
            hints = "ㄷㄹㅂㄴㄹㅌㅅㅌ";
            answer[0] = "들러 보는 리틀 스타";
            answer[1] = "들러보는 리틀스타";
            answer[2] = "들러 보는 리틀스타";
            answer[3] = "들러보는 리틀 스타";
            answer[4] = "들러보는리틀스타";
            answer[5] = "들러보는 little star";
    ...
    if (true) { //샤니 셀렉터
        ...
        if (randp == 1171 || randp == 1172) {
            ...
            answer[1] = "catch the breeze";
            answer[2] = "캐치 더 브리즈";
            answer[3] = "케치 더 브리즈";
            answer[4] = "캐치 더브리즈";
            answer[5] = "캐치더브리즈";
            answer[6] = "catchthebreeze";
            ...
            hints = "ㅍㅇㄷㅁㅊ!!!";
            answer[0] = "Forward March!!!";
            answer[1] = "forward march!!!";
            answer[2] = "forward march";
            answer[3] = "포와드 마치!!!";
            answer[4] = "포와드 마치";
            answer[5] = "포와드마치";
            ...
            hints = "ㅂㄹㅇㅌㅅㅌㅎㅇㅌ";
            answer[0] = "BRIGHTEST WHITE";
            answer[1] = "brightest white";
            answer[2] = "브라이티스트 화이트";
            answer[3] = "브라이트스트 화이트";
            answer[4] = "브라이티스트화이트";
            answer[5] = "가장 밝은 화이트";
            ...
            hints = "ㅇㅅㅎㅇㄹㅅ";
            answer[0] = "Unsung Heroes";
            answer[1] = "";
            answer[2] = "";
            answer[3] = "";
            answer[4] = "";
            answer[5] = "";
        }if (randp == 1213 || randp == 1214) {
            hints = "ㅇㅊㅅㅇㄹㅋ";
            answer[0] = "유채색 유레카";
            answer[1] = "";
            answer[2] = "";
            ...
            answer[4] = "";
            answer[5] = "";
        }if (randp == 1215 || randp == 1216) {
            hints = "ㅎㄴㅅㅋㅅㅇㅅㅇ";
            answer[0] = "하나사카사이사이";
            answer[1] = "하나사카 사이사이";
            answer[2] = "hanasakasaisai";
            answer[3] = "하나사카사이사이";
            answer[4] = "하나싸카싸이싸이";
            answer[5] = "하나 사카 사이 사이";
        }if (randp == 1217 || randp == 1218) {
            hints = "ㅈㄹㅇㅅ";
            answer[0] = "전력 앤서";
            answer[1] = "전력앤서";
            answer[2] = "전력 엔서";
...
function SongChange() {
    ...
    if (
        notran.indexOf(randp) != -1 || (randp >= 1209 && randp <= 1214) || // <- 안티카 CANVAS 없음으로 제외
        (randp > 589) & (randp <= 1000) ||
        (randp > 1220 && randp <= 1500) ||
        (randp > 1780 && randp <= 2000) ||
        (randp > 2292 && randp <= 3000) ||
        (randp > 3028 && randp <= 3200) 
    ) {
        //alert('중복입니다.');
        SongChange();
        return 0;
    ...
    if (true) { //노래 받기 밀리 컬렉터
        if (randp == 1) {
            ...
            urllink = "1p1EaheKr08SYDEDA8tTrzKXzqVZmF0yd"; //espada
            flag = "밀리";
            videourl = "";
        } else if (randp == 565) {
            urllink = "1LAbpMsYjF8AG1-QQ3Qp0gAv0cJX-AH3b"; //espada
            flag = "밀리";
            videourl = "";
        } else if (randp == 566) {
            urllink = "1X7wPwVDc_ZRnWLoPOiW61WCBR-3BSFA-"; //크리미널리 디너
            flag = "밀리";
            videourl = "";
        } else if (randp == 567) {
            urllink = "1myT5U_bUdPLw0Cj8jpXvasrShRDccmYb"; //크리미널리 디너
            flag = "밀리";
            videourl = "";
        } else if (randp == 568) {
            urllink = "1PwKML0e_RCRGVE-bCg0G2tbNsib93U2j"; //스페이드의 q
            flag = "밀리";
            videourl = "";
        } else if (randp == 569) {
            urllink = "17S03PDM_MOk95-2zAsMZbbV5p4OuOAPR"; //스페이드의 큐
            flag = "밀리";
            videourl = "";
        } else if (randp == 570) {
            urllink = "1f846D9yogK1Ah52QLy4WsGo79qsjos6c"; //킹 오브 스페이드
            flag = "밀리";
            videourl = "";
        } else if (randp == 571) {
            urllink = "1SS7z55Ub-zZFgUogC96U1NVIXeJbydTU"; //킹 오브 스페이드
            flag = "밀리";
            videourl = "";
        } else if (randp == 572) {
            ...
            urllink = "1txy_tPJqnSdPS-DvgkjTa3Tw363dZ_IS"; //사운드 오브 비기닝
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 583) {
            urllink = "1IF2Ee0JDblAlH0WPy-tkLptkxgV-7g55"; //사운드 오브 비기닝
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 584) {
            urllink = "1WC-5aXpoY6TBrFJAGcJGJ8QeCN2GGAn5"; //Supersonic Booster!
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 585) {
            urllink = "1jzbht55YbqLARA3wiWka27RJ4RQMTyS-"; //Supersonic Booster
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 586) {
            urllink = "1xSaLqGrS27D7YLXsR0RN2uuh_K63jnio"; //오렌지 에피소드
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 587) {
            urllink = "1lRxEFcCbe4U5V8vDR4KMJcTKsPaJIDgk"; //오렌지 에피소드
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 588) {
            urllink = "1O_WpK54aobQEvvaDEzd_9A--DI6_HT44"; //Like twinkling STARS
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 589) {
            urllink = "1kD_DRaoGLoq16bWw8WLqB4eyG7qIo_Ef"; //Like twinkling STARS
            flag = "밀리";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 590) {
    ...
    if (true) { //노래 받기 샤니 컬렉터
        if (randp == 1003) {
            ...
            urllink = "1Kg1spWe1gZw_kqOYs4UUB2up4RVP70A1"; //캐치 더 브리즈
            flag = "샤니";
            videourl = "";
        } else if (randp == 1192) {
            urllink = "1zRA9_U9ixZ1ZPsRrRGps2hkIEnDhQ2Td"; //캐치 더 브리즈
            flag = "샤니";
            videourl = "";
        } else if (randp == 1193) {
            urllink = "1DADThbQ3Fnd6Prj6mFpajY_S_GW77q3P"; //아스팔트 울려
            flag = "샤니";
            videourl = "";
        } else if (randp == 1194) {
            urllink = "1Ov0h6fXHsMiMh8lAGXI5o7VhIbQtWD2n"; //아스팔트를 울려
            flag = "샤니";
            videourl = "";
        } else if (randp == 1195) {
            ...
            urllink = "1H9PJ66uJ2PoaxYvutC0loY2iN2S_ZC0S"; //Forward March
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1204) {
            urllink = "1Ptx5gsMgmbOkGUAVCsZ5Ph1AJkJ1GIj1"; //Forward March
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1205) {
            urllink = "1GpfE3myiE4NhsLfxCsaHItxNkMCSt5DI"; //별이 흐르고
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1206) {
            urllink = "1_iPbXkwPRQr2AeU55Em3Jxtvsh9yYEiA"; //별이 흐르고
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1207) {
            urllink = "1RomZBT0fRX0esQUlcxZIhplMD5JBsPRC"; //BRIGHTEST WHITE
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1208) {
            urllink = "131yX77Zkx_AkhH87bmP5t-hVRbQngLOc"; //BRIGHTEST WHITE
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1209) {
            ...
            urllink = "15dnfFpPxqkAeOGYkSzajr29naw0cUCE9"; //하나사카사이사이
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1216) {
            urllink = "1zD1PMOc-ThB0uw1sMfVy5BsjufgvlSnK"; //하나사카사이사이
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1217) {
            urllink = "1LppfCvu5uyN06PkVN_infTNOAmcTHO2j"; //전력 앤서
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1218) {
            urllink = "153D7LsPkWkNoue-NwWR0G2Xq7fAD_-lp"; //전력 앤서
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1219) {
            urllink = "1QGwX6EoBZ_YBy1q8BdHz4v7-X3xr3Czk"; //일력 모자이크
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1220) {
            urllink = "18-GiSdAKIS84o-2Y8np8swEOsr8rDddt"; //일력 모자이크
            flag = "샤니";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1221) {
    ...
    if (true) { //노래 받기 데레 셀렉터
        if (randp == 1501) {
            ...
            urllink = "1MG8ZPfIUk_HyCAkIvtW8yqtXHHgSgZDs"; //New bright stars
            flag = "데레";
            videourl = "";
        } else if (randp == 1760) {
            urllink = "1S1U4uaAIeLH6TDrDzncEpQr0JjeVKVRj"; //New bright stars
            flag = "데레";
            videourl = "";
        } else if (randp == 1761) {
            urllink = "1IOs_baigWkbvq0XfJNQEGzN0lEFVYkiZ"; //delight
            flag = "데레";
            videourl = "";
        } else if (randp == 1762) {
            urllink = "1hKmwyZ_fjM_V3fBW8nRN1OS1zG1X9dJy"; //delight
            flag = "데레";
            videourl = "";
        } else if (randp == 1763) {
            ...
            urllink = "10RIG8e1io3eI_yfU1pjrgR5RIYwHNOY0"; //Starry Night
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1774) {
            urllink = "1Z1duWSl8acsv_x6RjNysRuHNEeygvNOi"; //Starry Night
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1775) {
            urllink = "1ZShTd3WMgqOZdlVM8OuGu2UDwV_hYZoo"; //Shine In The Sky☆
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1776) {
            urllink = "12HBzdwmsqkaQE1dpMhzxht1_iGDcY-rc"; //Shine In The Sky
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1777) {
            urllink = "1b0t5MHG-Tm6bB84v-n0zcnp9t67YGUUq"; //들러 보는 리틀 스타
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1778) {
            urllink = "1MhjyWI3TlhB4b8BXJJAylY7d8r1_BIC7"; //들러 보는 리틀 스타
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1779) {
            urllink = "1f-d6qWpX_fsuaWwSzzIZsAHwNkge06U8"; //Nightwear
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1780) {
            urllink = "1GXp-ta5bjYXq0n_2bmVi7qYuQaw6KPb7"; //Nightwear
            flag = "데레";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 1781) {
    ...
    if (true) { //노래 받기 기타 셀렉터
        if (randp == 3001) {
            ...
            urllink = "1pExqz0USrhPZWr0DmRTk9yvzFf-0xZVz"; //CRYST@LOUD 
            flag = "기타";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 3028) {
            urllink = "1LcG01GecMVDd5Lxkm9yF0wlCN6Js8AUh"; //크리스탈라우드
            flag = "기타";
                        flagUD = "업";
            videourl = "";
        } else if (randp == 3029) {
    ...
    if(beta_mode){
        ...
        return 0;
            ...
            randp = Math.floor(Math.random() * 3200);
    if (
        notran.indexOf(randp) != -1 || (randp >= 1209 && randp <= 1214) ||
        (randp > 589) & (randp <= 1000) ||
