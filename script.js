...
function SongChange() {
    ...
    if (
        ...
        (randp > 553) & (randp <= 1000) ||
        (randp > 1186 && randp <= 1500) ||
        (randp > 1754 && randp <= 2000) ||
    ...
    if (true) { //노래 받기 샤니 컬렉터
        if (randp == 1003) {
            ...
            urllink = ""; //Tracing Defender 여기 링크 넣어야돼애ㅐ애애
            flag = "샤니";
            videourl = "";
        } else if (randp == 1188) {
            urllink = ""; //Tracing Defender
            flag = "샤니";
            videourl = "";
        } else if (randp == 1189) {
            urllink = ""; //Overdrive Emotion
            flag = "샤니";
            videourl = "";
        } else if (randp == 1190) {
            urllink = ""; //Overdrive Emotion
