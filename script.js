...
function SongChange() {
    ...
    if (
        ...
        (randp > 1168 && randp <= 1500) ||
        (randp > 1740 && randp <= 2000) ||
        (randp > 2288 && randp <= 3000) ||
    ...
    if (true) { //노래 받기 밀리 컬렉터
        if (randp == 1) {
            ...
            urllink = ""; //DETECTIVE HIGH! ~사랑탐정 이야기~
            flag = "밀리";
            videourl = "";
        } else if (randp == 517) {
            urllink = ""; //DETECTIVE HIGH! ~사랑탐정 이야기~
